...
class _ApplicationDetailSheetState extends ConsumerState<ApplicationDetailSheet> {
      ...
      final confirmed = await showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text('Please specify a reason for rejecting this service authorization:'),
      ...
      final confirmed = await showDialog<bool>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Specify reason for rejecting this document:'),
              const SizedBox(height: 10),
              TextField(
                controller: reasonCtrl,
                decoration: const InputDecoration(
        ...
        builder: (ctx) => AlertDialog(
          ...
          actions: [
            ...
            FilledButton.icon(
              ...
              label: Text('Approve Prerequisites First'),
                  ...
                  children: [
                    ...
                    _SectionBox(
                      ...
                      children: [
                        ...
                        _dataRow('Service Radius', _application.serviceRadius, isBold: true, highlightColor: AppColors.primary),
                      ],
                    ),
                    const SizedBox(height: AppSpacing.md),
                    _SectionBox(
                          ...
                          Wrap(
                            ...
                            children: _application.skills.entries.map((e) {
                              return Container(
                                ...
                                child: Text(
                                  '${e.key}: ${e.value}',
                                  style: TextStyle(fontSize: 10.5, color: AppColors.textSecondary, fontWeight: FontWeight.w700),
                                ),
                              );
                            }).toList(),
                          ),
                                ...
                                children: [
                                  ...
                                  if (svc.rejectionReason != null && svc.rejectionReason!.isNotEmpty) ...[
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(fontSize: 10.5, color: Color(0xFFDC2626)),
                                    ),
                                  ],
                              ...
                              return Column(
                                ...
                                children: [
                                  FilledButton.icon(
                                    ...
                                    label: Text('Approve Application'),
                                    style: FilledButton.styleFrom(
                                  ...
                                  child: FilledButton.icon(
                                    ...
                                    style: FilledButton.styleFrom(
                                      backgroundColor: isReadyForApproval
                                          ...
                                          : AppColors.primary,
                                      padding: const EdgeInsets.symmetric(vertical: 10),
                                      textStyle: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w800),
                                    ),
                                  ),
                                ),
                              ],
  ...
  Widget _buildPrerequisitesCard({
    ...
    return Container(
      padding: const EdgeInsets.all(AppSpacing.md),
      decoration: BoxDecoration(
        color: isReady ? AppColors.successBg : AppColors.warningBg,
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  fontSize: 11.5,
                  fontWeight: FontWeight.w700,
                  color: isSatisfied ? AppColors.textPrimary : const Color(0xFF78350F),
                ),
              ),
              Text(
                detail,
