...
urlpatterns = [
    ...
    path("seller-hub/orders/<int:pk>/arrive-pickup/", SellerOrderRiderArrivePickupView.as_view(), name="seller-hub-orders-arrive-pickup"),
    path("seller-hub/orders/<int:pk>/verify-pickup-otp/", SellerOrderRiderVerifyPickupOTPView.as_view(), name="seller-hub-orders-verify-pickup-otp"),
