...
ALLOWED_TRANSITIONS = {
    ...
    "assigned": ["received", "accepted", "reassigned", "redispatching", "cancelled", "on_the_way", "en_route", "arrived", "service_started", "in_progress"],
    "received": ["accepted", "reassigned", "redispatching", "cancelled"],
    "accepted": ["on_the_way", "en_route", "arrived", "redispatching", "cancelled", "unable_to_complete", "in_progress"],
    "on_the_way": ["arrived", "redispatching", "cancelled", "unable_to_complete"],
    "en_route": ["arrived", "redispatching", "cancelled", "unable_to_complete"],
    "arrived": ["service_started", "in_progress", "cancelled", "unable_to_complete", "quotation_created", "inspection_completed", "quotation_sent"],
